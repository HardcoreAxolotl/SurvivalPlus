package net.mcreator.survivalplus;
...
@Mod("survivalplus")
public class SurvivalplusMod {
	public static final Logger LOGGER = LogManager.getLogger(SurvivalplusMod.class);
	public static final String MODID = "survivalplus";

	public SurvivalplusMod(IEventBus modEventBus) {
