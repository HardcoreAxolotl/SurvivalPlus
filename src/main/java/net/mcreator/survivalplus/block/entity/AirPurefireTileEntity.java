package net.mcreator.survivalplus.block.entity;
...
public class AirPurefireTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public AirPurefireTileEntity(BlockPos pos, BlockState state) {
		super(SurvivalplusModBlockEntities.AIR_PUREFIRE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(AirPurefireBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<AirPurefireTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<AirPurefireTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("air_purefire");
	}
