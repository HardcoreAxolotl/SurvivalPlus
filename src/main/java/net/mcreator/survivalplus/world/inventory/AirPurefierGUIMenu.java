...
public class AirPurefierGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AirPurefierGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SurvivalplusModMenus.AIR_PUREFIER_GUI.get(), id);
